  ...
  return (
    <AppShell>
      ...
      <div className="mt-5 flex w-full flex-col gap-5">
        <div className="flex items-center gap-2 rounded-xl border border-success/20 bg-success/10 px-3.5 py-2.5">
        ...
        <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4" aria-label="Statistici seif">
        ...
        <Card className="border-border/80 p-5 shadow-none">
          ...
          <Progress value={completenessPct} className="mb-4 h-1.5" />
